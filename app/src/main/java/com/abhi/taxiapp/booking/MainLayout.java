package com.abhi.taxiapp.booking;
...
public class MainLayout extends LinearLayout {
    ...
    private static final int RESIZE_ANIMATION_DURATION = 400;
    ...
    private static int menuRightMargin = 200;
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        menuRightMargin = mainLayoutWidth * 45 / 100;
    ...
    public void toggleMenu(TextView tv1, TextView tv2) {
        ...
        switch (currentMenuState) {
            ...
            case HIDDEN:
                ...
                menuScroller.startScroll(0, 0, menu.getLayoutParams().width,
                        menu.getLayoutParams().height, SLIDING_DURATION);
                ...
                _tv1.startAnimation(resizeAnimation);
                ...
                resizeAnimation2.setDuration(RESIZE_ANIMATION_DURATION);
                _tv2.startAnimation(resizeAnimation2);
            ...
            case SHOWN:
                ...
                ResizeAnimation resizeAnimation3 = new ResizeAnimation(
                        _tv1,
                        -150,
                        150
                );
                resizeAnimation3.setDuration(RESIZE_ANIMATION_DURATION);
                _tv1.startAnimation(resizeAnimation3);

                ResizeAnimation resizeAnimation4 = new ResizeAnimation(
                        _tv2,
                        -150,
                        150
                );
                resizeAnimation4.setDuration(RESIZE_ANIMATION_DURATION);
                _tv2.startAnimation(resizeAnimation4);
    ...
    public boolean onContentTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            //removed to stop content dragging
