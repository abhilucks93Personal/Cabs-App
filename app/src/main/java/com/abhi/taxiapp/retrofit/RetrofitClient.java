...
public class RetrofitClient {
    ...
    public static final String BASE_URL = "http://cabapi.demoxl.com/";
    ...
    static OkHttpClient httpClient = new OkHttpClient.Builder()
            ...
            .addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    Request request;
                   /* if(new App().getToken() != null && !new App().getToken().equalsIgnoreCase("") && !new App().getToken().equalsIgnoreCase("null")) {
                        request = chain.request().newBuilder().addHeader("Authorization", "bearer " + new App().getToken()).build();
                    }else{
